...
public class FileLoaderController {
	...
	protected void handleStartLoadingButtonAction(ActionEvent event) {
		...
		if (clickLog == null || serverLog == null || impressionLog == null) {
		...
		} else if (Parser.isValidClickLog(clickLog) && Parser.isValidImpressionLog(impressionLog)
				&& Parser.isValidServerLog(serverLog)) {
			...
			if (!Parser.isValidClickLog(clickLog))
				invalidFileErrorBox.setContentText(invalidFileErrorBox.getContentText() + " Click Log, ");
			if (!Parser.isValidServerLog(serverLog))
				invalidFileErrorBox.setContentText(invalidFileErrorBox.getContentText() + " Server Log, ");
			if (!Parser.isValidImpressionLog(impressionLog))
